...
@Component({
  ...
  template: `
    <div *ngIf="role === 'Employee'; else notAllowed">
      <div class="card">
          ...
          <form [formGroup]="leaveForm" (ngSubmit)="onSubmit()">
            ...
            <div *ngIf="step === 2">
              ...
              <div class="mb-3">
                ...
                <div
                  *ngIf="
                    leaveForm.get('to')?.invalid && leaveForm.get('to')?.touched
                  "
                  class="text-danger"
                >
              ...
              <div class="mb-3">
                ...
                <ul class="list-group">
                  <li class="list-group-item">
                    <b>Type:</b> {{ leaveForm.value.type }}
                  </li>
                  <li class="list-group-item">
                    <b>From:</b> {{ leaveForm.value.from }}
                  </li>
                  <li class="list-group-item">
                    <b>To:</b> {{ leaveForm.value.to }}
                  </li>
                  <li class="list-group-item">
                    <b>Reason:</b> {{ leaveForm.value.reason }}
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-4">
              ...
              <button *ngIf="step === 4" class="btn btn-primary" type="submit">
                Submit
              </button>
            </div>
          </form>
...
export class LeaveApplyComponent {
  ...
  nextStep() {
    ...
    if (
      this.step === 2 &&
      (this.leaveForm.get('from')?.invalid || this.leaveForm.get('to')?.invalid)
    ) {
  ...
  canProceed() {
    ...
    if (this.step === 2)
      return (
        this.leaveForm.get('from')?.valid && this.leaveForm.get('to')?.valid
      );
    return true;
  }
  onSubmit() {
